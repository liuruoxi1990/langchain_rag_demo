...
本段文字人工生成：本项目Codex生成，供初学者了解langchain和RAG基础知识和流程，模型和API可以根据个人使用习惯进行修改，Rerank模型没有配置，用的MMR搜索，向量库拿Chroma本地跑着，可以换成高级的，langchain没有太用起来，可以改成Chain结构，有兴趣可以拿AI继续魔改
